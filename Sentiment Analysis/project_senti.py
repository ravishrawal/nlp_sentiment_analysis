...
width = 0.35  # the width of the bars
fig, ax = plt.subplots()
rects1 = ax.bar(x, [avg_senti1,avg_senti2,avg_senti3,avg_senti4,avg_senti5], width, label='Sentiment',color = 'white')
ax.set_xlabel('Overall Ratings')
ax.set_ylabel('Average Sentiment')
ax.set_xticks(x)
ax.set_xticklabels(['1','2','3','4','5'])
ax.set_ylim(ymin = 0.0, ymax = 5.0)
ax.errorbar(x = ['1'], y = avg_senti1, yerr = std_avg_senti1,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['2'], y = avg_senti2, yerr = std_avg_senti2,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['3'], y = avg_senti3, yerr = std_avg_senti3,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['4'], y = avg_senti4, yerr = std_avg_senti4,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['5'], y = avg_senti5, yerr = std_avg_senti5,ecolor='black',capsize=4,fmt='or')
# data values on each bar
# ax.bar_label(rects1, padding=3)
# ax.bar_label(rects2, padding=3)
fig.tight_layout()
...
width = 0.35  # the width of the bars
fig, ax = plt.subplots()
rects1 = ax.bar(x, [pro_senti1,pro_senti2,pro_senti3,pro_senti4,pro_senti5], width, label='Sentiment',color = 'white')
ax.set_xlabel('Overall Ratings')
ax.set_ylabel('Average Sentiment')
ax.set_xticks(x)
ax.set_xticklabels(['1','2','3','4','5'])
ax.set_ylim(ymin = 0.0, ymax = 5.0)
ax.errorbar(x = ['1'], y = pro_senti1, yerr = std_pro_senti1,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['2'], y = pro_senti2, yerr = std_pro_senti2,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['3'], y = pro_senti3, yerr = std_pro_senti3,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['4'], y = pro_senti4, yerr = std_pro_senti4,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['5'], y = pro_senti5, yerr = std_pro_senti5,ecolor='black',capsize=4,fmt='or')
# data values on each bar
# ax.bar_label(rects1, padding=3)
# ax.bar_label(rects2, padding=3)
fig.tight_layout()
...
width = 0.35  # the width of the bars
fig, ax = plt.subplots()
rects1 = ax.bar(x, [con_senti1,con_senti2,con_senti3,con_senti4,con_senti5], width, label='Sentiment',color = 'white')
ax.set_xlabel('Overall Ratings')
ax.set_ylabel('Average Sentiment')
ax.set_xticks(x)
ax.set_xticklabels(['1','2','3','4','5'])
ax.set_ylim(ymin = 0.0, ymax = 5.0)
ax.errorbar(x = ['1'], y = con_senti1, yerr = std_con_senti1,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['2'], y = con_senti2, yerr = std_con_senti2,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['3'], y = con_senti3, yerr = std_con_senti3,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['4'], y = con_senti4, yerr = std_con_senti4,ecolor='black',capsize=4,fmt='or')
ax.errorbar(x = ['5'], y = con_senti5, yerr = std_con_senti5,ecolor='black',capsize=4,fmt='or')
# data values on each bar
# ax.bar_label(rects1, padding=3)
# ax.bar_label(rects2, padding=3)
fig.tight_layout()
